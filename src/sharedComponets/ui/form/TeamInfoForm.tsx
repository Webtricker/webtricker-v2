...
export default function TeamInfoForm({
  ...
  return (
    <>
      <div className={`w-full p-5 lg:p-6 rounded-[10px] shadow-xl ${className}`}>
        <div className={`w-full ${imgContainerStyle}`}>
          <label htmlFor="" className="mb-1 block wt_fs-md">
            Profile
          </label>
          <div className={`w-full  group relative flex items-center justify-center border border-slate-300 rounded-[10px] mb-5 ${imgContainerStyle}`}>
            {profile ? (
              <>
                <Image
                  src={profile}
