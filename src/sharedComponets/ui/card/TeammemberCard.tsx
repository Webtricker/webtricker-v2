...
export default function TeammemberCard({ team }: { team: ILeaderInfo }) {
  return (
    <div className="p-10 rounded-[8px] w-full mx-0.5 sm:mx-0 sm:max-w-[330px] dark:shadow dark:shadow-white dark:hover:shadow-md dark:hover:shadow-slate-600 duration-300 shadow-md shadow-slate-300 hover:shadow dark:hover:border-t dark:hover:border-t-slate-600 border-t border-t-slate-300">
