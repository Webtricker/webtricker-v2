...
import TestimonialsDataContainer from "./components/TestimonialsDataContainer";

export default function TestimonialCustomizationPage() {
  return (
    <PrivatePageWrapper className="!p-0">
      <main className="w-full z-0">
        <section className=" w-full py-3 px-4 md:px-5 lg:px-10 left-0 flex items-center justify-between lg:bg-slate-100">
          <PageTitle key="TESTIMONIALS" title="TESTIMONIALS" />
