...
type Props = {
  logo: IMainHeader["logo"];
  setValue: UseFormSetValue<IMainHeader>;
};

type TTarget = "white" | "black";

// variables
const ACTIVE_KEY = "OPEN_MAIN_HEADER_LOGO_MODAL";

export default function MainHeaderLogos({ logo, setValue }: Props) {
  //hooks
