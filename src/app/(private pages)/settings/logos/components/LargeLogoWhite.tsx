...
export default function LargeLogoWhite() {
  ...
  const handleEditClick = () => {
    dispatch(toggleModal("OPEN_LIGHT_LARGE_LOGO_MODAL"));
  };
  ...
  return (
    <>
      ...
      <MediaModal
        ...
        activeKey="OPEN_LIGHT_LARGE_LOGO_MODAL"
        key={"OPEN_LIGHT_LARGE_LOGO_MODAL"}
        cb={handleImgSelect}
      />
    </>
  );
