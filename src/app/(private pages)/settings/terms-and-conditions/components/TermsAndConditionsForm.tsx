...
export default function TermsAndConditionsForm() {
  ...
  useEffect(() => {
    fetch("/api/terms-and-conditions", { credentials: "include" })
      .then((res) => res.json())
      .then((data) => {
        if (data?.data) {
      ...
      .catch(() => toast.error("Failed to load terms and conditions data"))
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400">
            Edit the terms and conditions page title, description, and content.
          </p>
        </CardHeader>
        <CardContent>
