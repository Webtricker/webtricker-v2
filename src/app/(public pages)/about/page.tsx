      ...
      <section className='py-8 md:py-10 lg:py-14 xl:py-16 2xl:py-18'>
        <Container>
          <div className='w-full max-w-[1200px]'>
            <h3 className=''>
              We are a creative studio that specializes in providing high-quality design and
              branding solutions to businesses and individuals. Our team is composed of talented
        ...
        <Container className='flex lg:items-center gap-12 md:gap-18 xl:gap-20 2xl:gap-28 flex-col lg:flex-row'>
          <div className='w-full flex flex-col gap-5 '>
            <div className='w-full'>
              ...
              <p>
                Webtricker Web Design & Development Agency is a total solution of your website
                related requirements. From branding to web design and then web design to web
                development. And finally deploy to the hosting. We do everything as one stop service
                center.
              </p>
            </div>
            <div className='w-full'>
              ...
              <p>
                Being professional in web development, mobile application, and digital marketing
                companies. Our mission is to provide customer-centric, result-oriented,
                cost-competitive innovative & functional IT Solutions to our valuable global clients
              </p>
            </div>
            <div className='w-full'>
              <h4 className='heading md:mb-1'>Our goals</h4>
              <p>
                We are focused on providing your users the BEST experience they can have on your
                website. We love creating UNIQUE, ELEGANT and USABLE websites built on solid web
                standards.
              </p>
            </div>
            <div className='w-full'>
              ...
              <p>
                One of the first things you should know about us is that we don’t do everything. But
                what we do, we do well. We always try to value our clients time and money. Let us
                prove it by involving us with you with any of the following services. We&apos;d be
                happy to serve you with our maximum effort.
              </p>
            </div>
          </div>
      ...
      <section className='pt-8 md:pt-10 lg:pt-14 xl:pt-16 2xl:pt-18'>
        <Container className='w-full flex flex-col'>
          <p className='bold text-center mb-2 lg:mb-0'>
            SEND YOUR RESUME TO{' '}
            <Link data-wt-hide-cursor target='_blank' href='mailto:career@webtricker.com'>
