        ...
        >
          {[...teamData, ...teamData, ...teamData].map((item, index) => (
            <SwiperSlide className="my-4 ms-[6.8px] md:ms-0" key={index}>
              <div className="p-4 flex flex-col gap-6 items-center min-h-[450px] justify-center dark:shadow dark:shadow-white dark:hover:shadow-md dark:hover:shadow-slate-600 duration-300 shadow-md shadow-slate-300 hover:shadow rounded-[8px] dark:hover:border-t dark:hover:border-t-slate-600">
                <Image
