        ...
        <Container className='flex items-center justify-center'>
          <div className='w-full max-w-[1000px] text-center bg-slate-800/30 rounded-[10px] p-4'>
            ...
            <p className='!text-white wt_text-shadow wt_fs-xl bold mt-5'>
              Experience the synergy of design and technology. As a full-service digital partner, we
              bring your brand to life through transformative digital solutions and captivating
              experiences
            </p>
          </div>
        </Container>
