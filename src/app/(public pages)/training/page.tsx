                ...
                <div className="container mx-auto px-4 py-12">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                            Enhance your skills with our comprehensive training
                            programs designed for modern professionals
                        </p>
                    </div>
                                        ...
                                        <div className="space-y-2">
                                            <div className="flex items-center justify-between text-sm">
                                                ...
                                                <span className="bg-gray-100 text-black px-2 py-1 rounded-md font-medium">
                                                    {course.onlineFee.toLocaleString()}{" "}
                                                    {course.currency}
                                                </span>
                                            </div>
                                            ...
                                            <div className="flex items-center justify-between text-sm">
                                                ...
                                                <span className="border border-gray-300 text-black px-2 py-1 rounded-md font-medium">
                                                    {course.offlineFee.toLocaleString()}{" "}
                                                    {course.currency}
                                                </span>
                                            </div>
                                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mt-8">
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-sm text-gray-600">
                                        ...
                                        complimentary internship program
                                    </p>
                                </div>
                                ...
                                <div className="text-center">
                                    ...
                                    <p className="text-sm text-gray-600">
                                        ...
                                        assistance after internship completion
                                    </p>
                                </div>
                            </div>
                        </div>
